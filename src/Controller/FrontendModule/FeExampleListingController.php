...
namespace Diversworld\ContaoExampleModuleBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'fe_example_module')]
class FeExampleListingController extends AbstractFrontendModuleController
{
    public const TYPE = 'fe_example_listing';
